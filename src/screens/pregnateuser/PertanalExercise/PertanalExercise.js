...
const EXERCISE_GUIDELINES = {
  ...
  subheader:
    'A comprehensive guide to beneficial exercises and important safety precautions during all trimesters of pregnancy.',
  safeExercises: [
    {
      title: 'Walking',
      icon: '🚶‍♀',
      ...
      details:
        'An excellent cardiovascular workout that is low-impact and easily adaptable. Aim for a brisk pace that still allows you to hold a conversation. Ensure you wear supportive footwear.',
    },
    {
      ...
      details:
        "The buoyancy of water supports your weight, relieving pressure on joints and ligaments. It's fantastic for reducing swelling and preventing overheating. Avoid diving or strenuous underwater exertion.",
    },
    {
      ...
      details:
        'Focuses on breathing, flexibility, balance, and strengthening core muscles crucial for labor and recovery. Avoid positions that involve lying flat on your back after the first trimester.',
    },
    {
      ...
      color: '#800080', // Purple
      details:
        'Using light weights or resistance bands helps maintain muscle tone and prepare for lifting the baby. Focus on high repetitions with low weight. Always prioritize proper form over intensity.',
    },
  ],
  safetyWarnings: [
  ...
  return (
    <View style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        {/* Header */}
        <Text style={styles.header}>{EXERCISE_GUIDELINES.header}</Text>
        <Text style={styles.subheader}>{EXERCISE_GUIDELINES.subheader}</Text>
        ...
        {EXERCISE_GUIDELINES.safeExercises.map((exercise, index) => (
          <View key={index} style={styles.exerciseCard}>
            <View
              style={[styles.titleBar, { backgroundColor: exercise.color }]}
            >
