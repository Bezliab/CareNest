...
const WELLNESS_GUIDELINES = {
  ...
  subheader:
    'Prioritizing your emotional health and restful sleep is essential for a healthy pregnancy journey.',
  wellnessTips: [
    {
      ...
      details:
        'Dedicate 10-15 minutes daily to deep breathing or guided meditation. This can significantly reduce stress hormones and promote a sense of calm.',
    },
    {
      ...
      details:
        "Talk openly with your partner, family, or friends about your feelings. Don't hesitate to reach out to a professional therapist or counselor if anxiety or sadness persists.",
    },
    {
      title: 'Journaling',
      icon: '✍',
      ...
      details:
        'Writing down your thoughts, fears, and joys can be a powerful emotional release. It helps process mood swings and track what contributes to your well-being.',
    },
  ],
  sleepTips: [
  ...
  return (
    <View style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        {/* Header */}
        <Text style={styles.header}>{WELLNESS_GUIDELINES.header}</Text>
        <Text style={styles.subheader}>{WELLNESS_GUIDELINES.subheader}</Text>
