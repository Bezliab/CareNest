...
const PREP_GUIDELINES = {
  ...
  subheader:
    'Knowledge and planning reduce anxiety. Prepare for the big day with these essential steps.',
  preparationSteps: [
    {
      ...
      details:
        'Document your preferences for pain management, medical interventions, feeding choices, and who you want in the room. Share it with your medical team early.',
    },
    {
      ...
      color: '#dda0dd', // Plum
      details:
        'Enroll in prenatal classes covering Lamaze, Bradley method, C-section recovery, and infant CPR. Practice breathing and coping techniques with your partner.',
    },
    {
      ...
      color: '#ffd700', // Gold
      details:
        'Have your bags ready for mom, partner, and baby by the 36th week. Include essentials like comfortable clothes, toiletries, snacks, and important documents.',
    },
    {
      ...
      details:
        'Be aware of early signs like the water breaking, regular contractions, and bloody show. Know when to call your doctor or midwife.',
    },
  ],
  laborStages: [
  ...
  return (
    <View style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        {/* Header */}
        <Text style={styles.header}>{PREP_GUIDELINES.header}</Text>
        <Text style={styles.subheader}>{PREP_GUIDELINES.subheader}</Text>
