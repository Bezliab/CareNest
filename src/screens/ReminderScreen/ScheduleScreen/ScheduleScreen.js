  ...
  const todayReminders = [
    {
      ...
      title: 'Take Vitamins',
      time: '8:00 AM',
      desc: 'Prenatal vitamins with water',
    ...
    },
    {
      ...
      time: '10:00 AM',
      desc: 'Clinic checkup with Dr. James',
      icon: 'medkit-outline',
    },
    {
      id: 3,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Scheduled Reminders</Text>
